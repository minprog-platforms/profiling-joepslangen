...
* Joep Slangen
*
* Improving the runtime and time complexity of a sudoku solver by improving the methods and functions
# By making use of profilers, mypy and snakeviz
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
class Sudoku:
    ...
    def options_at(self, x: int, y: int) -> Iterable[int]:
        ...
        # subtract rows, columns and block index to get viable options
        options = {1, 2, 3, 4, 5, 6, 7, 8, 9} - set(self.row_values(y)) - set(self.column_values(x)) - set(self.block_values(block_index))
